...
var getAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userStore.getAll()];
            case 1:
                userData = _a.sent();
                res.json({
                    status: 'success',
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                try {
                    token = jsonwebtoken_1["default"].sign({ user: data }, process.env.SECRET_TOKEN);
...
var register = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, userData, userExists, data, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                ...
                return [4 /*yield*/, userStore.getByColumn('username', userData.username)];
            case 1:
                userExists = _a.sent();
                if (userExists != null) {
                ...
                return [4 /*yield*/, userStore.create(userData)];
            case 2:
                data = _a.sent();
