...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var productData, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productStore.getByColumn('id', req.params.id)];
            case 1:
                productData = _a.sent();
                if (!productData) {
                    return [2 /*return*/, res.status(403).json({ status: 'failed', 'message': 'Product not found' })];
                }
                res.json({
                    status: 'success',
                    data: productData || {}
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, productStore.create(productData)];
            case 1:
