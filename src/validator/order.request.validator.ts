...
export class OrderRequestValidator {
  public validateCreate = [
    body('user_id', 'user_id should exists and valid')
      .exists()
      .bail()
      .notEmpty()
      .bail()
    ...
    check('products.*.product_id', 'product_id should be int and exists')
      .isInt()
      .bail()
      .custom(async (value) => {
    ...
    check(
      ...
      'product_quantity greater than 0 and less than 10000'
    )
      .exists()
      .bail()
      .isNumeric()
  ...
  public validateUserOrders = [
    ...
    check('order_status').custom((value) => {
